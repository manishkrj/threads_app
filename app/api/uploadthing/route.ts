...
const createTimeoutHandler = (
  handler: (req: NextApiRequest | Request, res: NextApiResponse) => Promise<void>,
  maxDuration: number
) => {
...
export const GET = createTimeoutHandler(async (request: NextApiRequest | Request, response: NextApiResponse) => {
...
export const POST = createTimeoutHandler(async (request: NextApiRequest | Request, response: NextApiResponse) => {
